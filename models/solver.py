...
class Solver:
    ...
    def run_parallel_gda_from_json(self, config_file, data, output_file='gda_results.json', input_file=None, mode='enhanced'):
        """
        ...
        if results and input_file and results[0].get('solution'):
            try:
                ...
                best_solution_file = f"output/jsontorun/{mode}/{input_filename}.txt"
                
                # Ensure output directory exists
                os.makedirs(f"output/jsontorun/{mode}", exist_ok=True)
